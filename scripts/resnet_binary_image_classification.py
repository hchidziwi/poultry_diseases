...
from tensorflow.keras.applications import MobileNetV2, densenet, ResNet152
...
# save model
model.save('resnet_binary_image_classification.h5')
print('Model Saved!')

# Save training history to a CSV file
csv_file_path = "../results/resnet_binary_training_history.csv"
